...
import { AuthenticityDetailsDialog } from './AuthenticityDetailsDialog';
...
export function FeedCard({ feed, onViewDetails }: FeedCardProps) {
    ...
    <>
      <div className="relative w-full h-96 overflow-hidden rounded-xl shadow-lg group">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-6 text-white">
          ...
          <Button variant="outline" className="w-full bg-white/20 border-white text-white hover:bg-white/30" onClick={handleOpenDialog}>
            View Details
          </Button>
        </div>
      </div>
